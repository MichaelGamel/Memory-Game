...
(function(w) {
  ...
  var playPromise = Background_Track.play();
  ...
  function Level(dur, arrOfCards) {
    ...
    function GenrateCards() {
      ...
      for (var i = 0; i < arrOfCards.length; i++) {
        boardContent +=
          ...
          "<div id='a" +
          i +
          "' class='back'  style='background-image:url(\"images/Cards/" +
          arrOfCards[i] +
          "\");' >" +
          "</div>" +
        ...
        if (i == arrOfCards.length) {
          ...
          setTimeout(function() {
            ...
            var tt = setInterval(function() {
              ...
              if (i == 0) {
                // that mean if we flipped all the cards back
                ...
                for (var y = 0; y < arrOfCards.length; y++) {
                  document.getElementById("card" + y).style.pointerEvents =
                    "auto";
                }
                // to show the keys
                $("#options").show("slow");
    ...
    w.CheckCards = function(elem, val) {
      ...
      if (SelectedCards[0] == 0 && SelectedCards[0].className != "selected") {
        ...
        SelectedCards[1] == 0 &&
        SelectedCards[1].className != "selected" &&
        elem.className != "card" + level + " selected"
      ) {
        //play the flipping sound
        Flip_Sound.src = "audio/flip.mp3";
        Flip_Sound.play();
        ...
        if (SelectedCards[0] == SelectedCards[1]) {
          ...
          if (score == arrOfCards.length / 2) {
            ...
            if (level == 1) {
              ...
              board.innerHTML =
                ...
                "<div style='color:yellow; font-family:CHLORINR;font-size:100px'> Your Score is " +
                score +
                " </div >" +
                "<input type='button' name='name' onclick='window.close();' value='Exit' id='Exitt' />" +
                "</div>";
          ...
          setTimeout(function() {
            //Add Some requred  time For Cards to be Fully Flipped after Selection
            //selecting the Cards thats already Matched
            var selected = document.getElementsByClassName("selected");
            ...
            document.getElementById(firstSelection.id).style.pointerEvents =
              "auto";
      ...
      if (src.indexOf("showCard") == -1) {
        ...
        switch (level) {
          case 0:
            ...
            //Next two lines  Prevent the user from Moving the Cards Untill the Flip Complete
            $("#card" + arr_cards0.lastIndexOf(x) + " div:first").addClass(
              "back"
            );
            $("#card" + arr_cards0.lastIndexOf(x) + " div:last").addClass(
              "front"
            );
            ...
            setTimeout(function() {
              //Give Time Until the Flip Complete
              //Flip the Cards Back
          ...
          case 1:
            ...
            //Getting the Second Element By Id After Getting The ID From The Array Using The IndexOf To get the index
            //Next two lines  Prevent the user from Moving the Cards Untill the Flip Complete
            $("#card" + arr_cards1.lastIndexOf(x) + " div:first").addClass(
              "back"
            );
            $("#card" + arr_cards1.lastIndexOf(x) + " div:last").addClass(
              "front"
            );
            //Flip the Matched Cards
          ...
          case 2:
            ...
            $("#card" + arr_cards2.lastIndexOf(x) + " div:first").addClass(
              "back"
            );
            $("#card" + arr_cards2.lastIndexOf(x) + " div:last").addClass(
              "front"
            );
